...
(function(root, factory) {
    ...
    function(moment, $) {
        var DateRangePicker = function(element, options, cb) {
            ...
            this.maxYear = moment().add(0, "year").format("YYYY");
            ...
            this.locale = {
                ...
                weekLabel: "W",
                customRangeLabel: "Slobodan odabir",
        ...
        DateRangePicker.prototype = {
            ...
            calculateChosenLabel: function() {
                ...
                for (var range in this.ranges) {
                    if (this.timePicker) {
                        ...
                        if (this.startDate.format(format) == this.ranges[range][0].format(format) &&
                            ...
                            customRange = false;
                            this.chosenLabel = this.container.find(".ranges li:eq(" + i + ")").addClass("active")
                                .attr("data-range-key");
                            break;
                        }
                    } else {
                ...
                if (customRange) {
                    if (this.showCustomRangeLabel) {
                        this.chosenLabel =
                            this.container.find(".ranges li:last").addClass("active").attr("data-range-key");
                    } else {
