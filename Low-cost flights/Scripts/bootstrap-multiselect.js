    ...
    function ($, ko) {
        ...
        Multiselect.prototype = {
            defaults: {
                ...
                nonSelectedText: "Odaberi...",
                nSelectedText: "označeno",
                allSelectedText: "Sve označeno",
                numberDisplayed: 2,
                ...
                templates: {
                    ...
                    filter:
                        '<li class="multiselect-item multiselect-filter"><div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span><input class="form-control multiselect-search" type="text" style="width:200px;" /></div></li>',
                    filterClearBtn:
